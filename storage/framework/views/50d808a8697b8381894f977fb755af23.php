...
<header class="blog-header py-3">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <!-- Site Title -->
            <a class="blog-header-logo text-dark text-center" href="<?php echo e(url('/')); ?>" style="font-weight: bold; text-decoration: none;">
                <h3>CEYLON TRAVEL</h3>
            </a>
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
        <li><a class="dropdown-item" href="<?php echo e(route('home')); ?>">Dashboard</a></li>
        <li><a class="dropdown-item" href="<?php echo e(route('posts.store')); ?>">New Post</a></li>
        <li><a class="dropdown-item" href="<?php echo e(route('posts.all')); ?>">All Posts</a></li>
        <li>
...
<?php if(auth()->guard()->guest()): ?>
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary">Sign Up</a>
    <?php endif; ?>
        ...
        <div id="menu" class="bg-dark text-white position-absolute p-3" style="top: 70px; left: 0; display: none; width: 200px; z-index: 10;">
            <ul class="list-unstyled">
                <li><a class="text-white" href="<?php echo e(url('/home')); ?>">Home</a></li>
...
<div class="container mt-4">
    ...
    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card shadow-sm border-0 h-100">
          <img src="<?php echo e(asset('thumbnails/' . $Post->thumbnail)); ?>" class="card-img-top img-fluid" alt="Post Thumbnail" style="object-fit: cover; height: 200px;">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title text-truncate"><?php echo e($Post->title); ?></h5>
            <p class="card-text text-muted small mb-2"><?php echo e(date('Y-m-d', strtotime($Post->created_at))); ?></p>
            <p class="card-text text-truncate"><?php echo e(Str::limit($Post->description, 80)); ?></p>
            <a href="<?php echo e(route('posts.show', $Post->id)); ?>" class="btn btn-primary mt-auto align-self-start">
              Read More
            </a>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="text-center small">
      &copy; <?php echo e(date('Y')); ?> CEYLON TRAVEL. All Rights Reserved.
    </div>
  </div>
</footer>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DESHAN\OneDrive\Desktop\laravel\demo\myblog\resources\views/Welcome.blade.php ENDPATH**/ ?>